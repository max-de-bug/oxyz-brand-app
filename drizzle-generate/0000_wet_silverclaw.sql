...
ALTER TABLE "processed_images" ADD CONSTRAINT "processed_images_logo_id_logos_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."logos"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
